$(document).ready(function() {
  ...
  // data
  var portfolioData = {
  	"sucesiones":" <ul> <li>• Sucesiones</li> <li>• Divorcios</li> <li>• Compensación económica</li> <li>• Convenios matrimoniales</li> <li>• Pactos de convivencia en la Unión convivencial</li> <li>• Responsabilidad parental</li> <li>• Cuidado personal de los hijos</li> <li>• Régimen de comunicación</li> </ul> </div>",
